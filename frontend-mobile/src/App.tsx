...
function App() {
  ...
  // Persistent Onboarding Registration State across Page Refreshes (Mobile) & URL Query Sync
  ...
  // Sync Onboarding & Portal State to URL and sessionStorage in Mobile (handles refresh, back button, gestures)
  useEffect(() => {
    if (storeSlug) return;
  ...
  // Mobile PopState listener for Back/Forward & gesture back navigation
  useEffect(() => {
